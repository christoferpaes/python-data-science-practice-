...
Original file is located at
    https://colab.research.google.com/drive/11e4j1hQDfcspM_zE7FOZaglWsmHdydmK
"""
...
import requests
import pandas as pd
url="https://www.youtube.com/watch?v=vTZSifqBy7s"
...
for entry in soup.find_all("entry"):
    ...
    for link in entry.find_all("link"):
        print(link["href"])
        luckylucky.append(link["href"])
    for name in entry.find_all("name"):
        print(name.text)
    for pub in entry.find_all("published"):
        print(pub.text)
print(type(luckylucky))
df1 = pd.DataFrame((luckylucky))
