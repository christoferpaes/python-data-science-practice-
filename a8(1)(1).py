...
##QUESTION NUMBER 1:#### While building the classifiers using KNN and logistic regression, how did you build your examples to train and test your classifiers?

                    ###: To train my models for logistic regression and KNN; first to fulfill the binary requirement for logistic regression needs to be a 1 or 0,and I chose to use the tenured or non tenured to train my model,to use the salary,and the number of years of worked.
                    ###: to train my KNN model I used the same classifiers the length of employment,the salary related to the length of employment , and the tenure or non tenure status to group my predictions.

##QUESTION NUMBER 2:#### How do you think the classifiers? Any one is better? And why?
                    ####: Personally, I dont believe that there is any better model type between logistic regression and knn, because KNN is used for grouping and clustering
                    ###(i.e., finding feature vectors that are similiar or are close in distance(if we were to convert the string, feature vector into a relatable integer)), while logistic regression can be used to make predictions related to this or that(1 or 0).
                    ### From my perspective it comes down to how you want to you view your data and what you're using it for.

"""# Turn-in

Turn in your notebook including your Python code and answers to the questions to D2L Assignments folder <b>Assignment 8</b>. In addition to the notebook document, you need to provide a pdf exported from your executed notebook.
"""
